...
import json
import urllib.parse
from Client.Config import AMQP as AMQP_Config
...
class ExamplePublisher(object):
    ...
    def __init__(self, amqp_url, exchange, exchange_type, queue, routing_key, publish_interval):
...
def main():
    ...
    example = ExamplePublisher('amqps://{0}:{1}@{2}:{3}/%2F?{4}'.format(AMQP_Config.USER,
                                                                        AMQP_Config.PASSWORD,
                                                                        AMQP_Config.HOST,
                                                                        AMQP_Config.PORT,
                                                                        urllib.parse.urlencode(
                                                                            AMQP_Config.SSL_OPTIONS)),
                               ...
                               publish_interval=AMQP_Config.PUBLISH_INTERVAL)
    example.run()
