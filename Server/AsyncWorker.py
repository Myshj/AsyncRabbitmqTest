...
from ServerConfig import AMQP as AMQP_Config
from ServerConfig import DB as DB_Config
...
def main():
    ...
    example = Worker('amqps://{0}:{1}@{2}:{3}/%2F?{4}'.format(AMQP_Config.USER,
                                                              AMQP_Config.PASSWORD,
                                                              AMQP_Config.HOST,
                                                              AMQP_Config.PORT,
                                                              urllib.parse.urlencode(AMQP_Config.SSL_OPTIONS)),
